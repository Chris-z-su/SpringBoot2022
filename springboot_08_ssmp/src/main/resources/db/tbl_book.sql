...
INSERT INTO `tbl_book` VALUES (10, '文学', '鲁迅全集', '大师全集，完整收录，鲁迅毕生之心血尽归于此。鲁迅是中国20世纪的文学家、思想家、革命家，中国近代文学巨匠。他早年留学于日本，后来弃医从文，他用笔耕不辍的文字为新一代青年们指引方向，在国内外思想文化领域有着极高的声誉。');
